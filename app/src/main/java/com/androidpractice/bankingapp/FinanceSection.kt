...
import com.androidpractice.bankingapp.data.Finance
...
fun FinanceSection() {
    Column {
        Text(text = "Finance", fontSize = 24.sp, color = MaterialTheme.colorScheme.background, fontWeight = FontWeight.Bold, modifier = Modifier.padding(16.dp))
